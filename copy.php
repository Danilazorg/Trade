...
<body class="animsition" class="color">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="active-menu">
								...
								<ul class="sub-menu">
									<li><a href="index.html">Рабочая станция</a></li>
									<li><a href="home-02.html">Базовый игровой</a></li>
									<li><a href="home-03.html">Мощный игровой</a></li>
								</ul>
							</li>

							<li>
								<a href="product.html">Покупателям</a>
							</li>

							<li >
								<a href="shoping-cart.html">Владельцам</a>
							</li>

							<li>
								<a href="blog.html">TRADE-IN</a>
							</li>
		...
		<div class="wrap-slick1 rs1-slick1">
			...
			<div class="slick1">
				...
				<div class="item-slick1" style="background-image: url(images/promo_tov.png); ">
					<div class="head_slidbar">
						<span class="rab_stan" style="color:#FDFAFA; border-bottom: 2px solid red;">Рабочая станция</span>
						<span class="baz_igr">Базовый игровой</span>
						<span class="moch_igr">Мощный игровой</span>
					</div>
					<div class="osnv_slidbar">
						<span class="zagolovok">Рабочая <br>станция</span>
						<br>
						<span class="dop_text">Оптимальный баланс производительности и цены для учебы и офисных задач.</span>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Product -->
	<section class="bg10 p-t-23 p-b-130 product">
		<div class="container">
			<div class="p-b-10">
			...
			<div class="row isotope-grid">
                  ...
                  <div class="block2 block_product">
						...
						<div class="opisan">
							...
							<button class="cupit">Купить</button>
						</div>
					</div>
				</div>
	...
	<section class="sec-product bg10 p-t-100 p-b-50  why">	
			<div class="p-b-32">
	...
	<section class="section-slide section-slide_down section-slide_down_page_product">
		<div class="wrap-slick1 rs1-slick1">
			<div class="slick1">
						...
						<div class="flex-col-l-m h-full p-t-100 p-b-30 slider_down">
							...
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								...
								<span class="ltext-202 cl2 respon2">
										...
										Мощные игровые компьютеры по доступным ценам
								</span>
							</div>
				...
				<div class="item-slick1" style="background-image: url(images/promo.png);">
					<div class="container h-full">
