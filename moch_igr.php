...
function articles_all_n($link){
    // Формируем запрос
        $query = "SELECT * FROM `Products` WHERE cat ='moch'";
			...
			<div class="slick1">
				...
				<div class="item-slick1" style="background-image: url(images/promo_tov.png); ">
					<div class="head_slidbar active_menu">
						...
						<span class="moch_igr" style="color:white;"><a href="moch_igr.php">Мощный игровой</a></span>
					</div>
					<div class="osnv_slidbar">
						<span class="zagolovok">Мощный<br>игровой</span>
						<br>
						<span class="dop_text">Железный монстр покоряющий игровые миры</span>
				</div>
			</div>
		</div>
	</section>
