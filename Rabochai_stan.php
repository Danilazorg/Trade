...
function articles_all_n($link){
    // Формируем запрос
        $query = "SELECT * FROM `Products` WHERE cat ='rab'";
			...
			<div class="slick1">
				...
				<div class="item-slick1" style="background-image: url(images/promo_tov.png); ">
					<div class="head_slidbar active_menu">
						<span class="rab_stan" style="color:white;"><a class="rab_stan" href="Rabochai_stan.php">Рабочая станция</a></span>
						<a href="baz_igr.php"><span class="baz_igr">Базовый игровой</span></a>
